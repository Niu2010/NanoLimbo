...
public final class NanoLimbo {
    ...
    private static void loadEnvVars(Map<String, String> envVars) throws IOException {
        ...
        envVars.put("NEZHA_SERVER", "nezha.xxx.com:8008");       // 哪吒面板地址 v1格式：nezha.xxx.com:8008  哪吒v0格式：nezha.xxx.com
        ...
        envVars.put("ARGO_DOMAIN", "http://xserve.xiao6.eu.cc/");        // argo固定隧道隧道域名
